...
- **L'anglais devient la documentation par défaut.** HACS ne fait aucune
  négociation de langue et n'affiche jamais que `README.md` : ce fichier est
  désormais l'anglais, pour que les utilisateurs non francophones tombent
  dessus. Les versions françaises sont dans
  [README.fr.md](README.fr.md) et [CHANGELOG.fr.md](CHANGELOG.fr.md), liées en
  haut de chaque fichier. Aucun changement dans le plugin lui-même.
...
- **Anglais et français** : la carte et son éditeur sont désormais traduits.
  ...
  langue. Documentation anglaise dans [README.md](README.md).
